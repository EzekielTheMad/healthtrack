...
const steps = [
  {
    ...
    description:
      'Sign up in seconds. Add basic info like age, sex, and any known conditions.',
  },
  {
    number: '02',
      ...
      <section className="px-6 py-20 md:py-28">
        ...
        >
          ...
          <p
            ...
            style={{ color: 'var(--color-text-muted)' }}
          >
            Join HealthTrack and take control of your medications, labs, vitals,
            and more — completely free.
          </p>
          <Link
            href="/login"
            className="relative z-10 inline-block px-8 py-3.5 rounded-full text-base font-bold no-underline transition-all hover:-translate-y-0.5"
            style={{ background: 'linear-gradient(135deg, var(--color-terracotta), var(--color-terracotta-light))', color: 'white', boxShadow: '0 4px 14px rgba(224, 122, 95, 0.3)' }}
          >
            Get Started Free
          </Link>
